...
{ 					
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOE,ENABLE);//使能PORTB,D,E,G以及AFIO复用功能时钟
 	...
 	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12;				 //PB12 推挽输出 背光
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOB, &GPIO_InitStructure);
	
 	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;				 //PB6 RST
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOB, &GPIO_InitStructure);
    ...
    //复位
    set_gpio_value(GPIOB, GPIO_Pin_6, 0);
    delay_ms(10);
    set_gpio_value(GPIOB, GPIO_Pin_6, 1);
    ...
    set_gpio_value(GPIOB, GPIO_Pin_12, 0);       // 亮背光
